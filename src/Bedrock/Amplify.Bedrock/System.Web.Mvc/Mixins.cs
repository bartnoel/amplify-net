...
namespace System.Web.Mvc
{
	public static class Mixins
	{
		...
		{
			HttpContextBase context = MockHttpContext();
			context.Request.MockRequestUrl(url);
			return context;
		}
		...
		public static void MockHttpMethodResult(this HttpRequestBase request, string httpMethod)
		{
			Mock.Get(request)
		...
		public static void MockRequestUrl(this HttpRequestBase request, string url)
		{
			if (url == null)
