...
namespace MbUnit.Framework
{
	...
	public static class BDD
	{
		...
		public static object ShouldBeTypeOf(this object obj, Type type)
		{
			return obj.ShouldBeTypeOf(type, "The types did not match");
		}

		public static object ShouldBeTypeOf(this object obj, Type type, string message)
		{
			Assert.AreEqual(obj.GetType(), type, message);
			return obj;
		}
